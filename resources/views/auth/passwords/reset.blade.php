...
@section('content')
    <form action="{{ route('password.update') }}" method="POST" class="mx-auto my-20 py-8 px-12 w-2/6 border border-side-focus rounded-lg text-center">
        @csrf
        ...
        <h1 class="text-text text-lg mb-2">Resetar senha</h1>
        ...
        <div class="flex items-center justify-between mt-8">
            ...
            <button class="text-default bg-link font-semibold tracking-wide text-sm px-6 py-2 rounded">Resetar senha</button>
        </div>
    </form>
@endsection
